# Проект. Этап 1: поиск и описание юридических данных для анализа
...
**Выдаётся:** семинар 4  
**Дедлайн:** семинар 6  
**Баллы:** по шкале из раздела «Контрольные точки» в README курса
...
```
# Проект, этап 1: поиск юридических данных
## ФИО, группа
...
Удачи в поиске данных! Этот набор данных будет основой для следующих этапов проекта, поэтому отнеситесь к выбору ответственно.