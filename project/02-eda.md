# Проект. Этап 2: разведочный анализ юридических данных (EDA)
...
```
# Проект, этап 2: разведочный анализ данных (EDA)
## ФИО, группа
...
A: Пока только анализируем. Стратегию заполнения разработаем на следующих этапах проекта.
