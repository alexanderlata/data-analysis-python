...
Показатели стран (заголовки столбцов на русском):

- Страны: название страны
- ИРЧП: индекс развития человеческого потенциала
- ВВП д/н: ВВП на душу населения, долл. США
- Население: численность населения, чел.
- Темп роста промышленности: %
- Безработица (%): уровень безработицы
- Ожидаемая продолжительность жизни: лет
- Кол-во действующих войск на тысячу граждан
- Уровень смертности (на 1000 чел.)

*Источник*: учебный набор, составлен по открытым страновым показателям; первичный источник не задокументирован.
